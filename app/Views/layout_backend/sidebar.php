<div class="left side-menu">
  ...
  <div class="topbar-left">
    <div class="text-center">
      <a href="index.html" class="logo"> Eksponen Bimbel</a>
    </div>
  </div>
  ...
  <div class="sidebar-inner slimscrollleft">
    ...
    <div id="sidebar-menu">
      <ul>
        ...
        <li>
          <a href="<?= site_url('kategori'); ?>" class="waves-effect">
            <i class="mdi mdi-school"></i>
            <span> Kategori Menu </span>
          </a>
        </li>
        <!-- <li>
          <a href="<?= site_url('kelas'); ?>" class="waves-effect">
            <i class="mdi mdi-school"></i>
            <span> Kategori Kelas </span>
          </a>
        </li> -->
        <li>
          <a href="<?= site_url('materi'); ?>" class="waves-effect">
