...
(function () {
  CKEDITOR.plugins.add("mathjax", {
    ...
    lang:
      "af,ar,az,bg,ca,cs,cy,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,et,eu,fa,fi,fr,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,oc,pl,pt,pt-br,ro,ru,sk,sl,sq,sr,sr-latn,sv,tr,tt,ug,uk,vi,zh,zh-cn", // %REMOVE_LINE_CORE%
    ...
    init: function (editor) {
      ...
      editor.widgets.add("mathjax", {
        ...
        template:
          '<span class="' +
          cls +
          '" style="display:inline-block" data-cke-survive=1></span>',
        ...
        init: function () {
          ...
          if (
            !iframe ||
            iframe.type != CKEDITOR.NODE_ELEMENT ||
            !iframe.is("iframe")
          ) {
          ...
          this.once("ready", function () {
            ...
            this.frameWrapper = new CKEDITOR.plugins.mathjax.frameWrapper(
              iframe,
              editor
            );
      ...
      editor.on("contentPreview", function (evt) {
        evt.data.dataValue = evt.data.dataValue.replace(
          /<\/head>/,
          '<script src="' +
            CKEDITOR.getUrl(editor.config.mathJaxLib) +
            '"></script></head>'
        );
      });
    ...
    CKEDITOR.plugins.mathjax.frameWrapper = function (iFrame, editor) {
      ...
      return {
        setValue: function (value) {
          ...
          tex.setHtml(
            CKEDITOR.plugins.mathjax.trim(CKEDITOR.tools.htmlEncode(value))
          );
